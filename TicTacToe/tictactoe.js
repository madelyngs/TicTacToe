    ...
    if (count !== 10) {
        ...
        switch (game) {
            ...
            case false:
                ...
                function game_on(cells) {
                    if (cells.currentTarget.textContent == 0) {
                        cells.currentTarget.textContent = value;
                        prev_val = value;
                        if (value !== " ") {
                            count = count + 1;
                            x = match_id(cells, value);
                        } else {
                            count = count + 0;
                        }
                        if (value == "X") {
                ...
                function match_id(cell, x_o) {
                    id = cell.currentTarget.id
